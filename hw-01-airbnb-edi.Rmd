...
The dataset has 13,245 observations.

1.  Run `View(edibnb)` in your Console to view the data in the data viewer. What does each row in the dataset represent?

Each row in the dataset represents information for specific towns.
